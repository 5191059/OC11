...
function addPro(id_value){
    ...
    var text = document.getElementById('ssdID' + id_value);
    ...
    var ssd_price = parent.document.getElementById("ssd_price");
    ssd_price.innerText = price;

    
    var Name = parent.document.getElementById('ssd_txt');
    Name.innerText = name;

    var Src = parent.document.getElementById('ssd_img');
    Src.src = src;
