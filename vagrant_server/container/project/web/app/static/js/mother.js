...
function addPro(id_value){
    ...
    var text = document.getElementById('motherID' + id_value);
    ...
    var mother_price = parent.document.getElementById("mother_price");
    mother_price.innerText = price;

    
    var Name = parent.document.getElementById('mother_txt');
    Name.innerText = name;

    var Src = parent.document.getElementById('mother_img');
    Src.src = src ;
